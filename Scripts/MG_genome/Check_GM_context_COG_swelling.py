...
- GWAS table: swelling_COGs.txt (expects a column with cluster or variant identifiers)
...
if cluster_col is None:
    raise ValueError("No cluster column found in swelling_COGs.txt. Expected one of: variant, cluster, cluster_id, COG, COG_id, panaroo_cluster")
