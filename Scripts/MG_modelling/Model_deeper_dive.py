...
plt.tight_layout()
plt.savefig('model_deeper_dive_dynamics.png', dpi=300)
plt.show()
...
plt.savefig('phase_plane_high_low_infection.png', dpi=300)
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('drug_coverage_infection_peaks.png', dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig('bifurcation_virulence_drug_coverage.png', dpi=300)
plt.show()
