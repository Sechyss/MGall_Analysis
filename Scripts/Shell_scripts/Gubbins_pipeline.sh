...
# Requirements: gubbins (run_gubbins.py, mask_gubbins_aln.py), IQ-TREE
 ...
 --prefix VA94_all_gubbins_run --date ~/OneDrive/Data/Cambridge_Project/Edited_all_samples_dates.txt --threads 10 --tree-builder iqtree --bootstrap 1000 --seed 1234 --best-model --model-fitter iqtree --recon-with-dates --filter-percentage 50 --extensive-search HF_V94_96HFgenomes.fasta
